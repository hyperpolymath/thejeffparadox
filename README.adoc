...
= The Jeff Paradox
image:https://img.shields.io/badge/OpenSSF-Best_Practices-green?logo=opensourcesecurity[OpenSSF Best Practices,link="https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/thejeffparadox"]
image:https://img.shields.io/badge/License-PMPL--1.0-indigo.svg[MPL-2.0,link="LICENSE"]
...
The PMPL extends MPL-2.0 with ethical use requirements and emotional lineage
preservation. For platform compatibility, files declare `MPL-2.0-or-later` in
SPDX headers. See `license/PMPL-1.0.txt` for the full text.

== Acknowledgements

*Based on https://criticalkit.us/products/the-jeff-paradox[The Jeff Paradox]*
by *Tim Roberts* / https://criticalkit.us[Critical Kit LLC].
